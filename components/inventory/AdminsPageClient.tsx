...
import { Plus, Search, Filter, ShieldCheck, MoreVertical } from 'lucide-react';

export default function AdminsPageClient() {
    return (
        <div>
            <Topbar title="Admins" subtitle="Manage administrative accounts and system access." product="inventory" />
            ...
            <div style={{ padding: 'var(--content-padding)' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16, marginBottom: 24 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        ...
                        <div>
                            <h2 style={{ fontSize: 24, fontWeight: 800, color: '#1a1a2e', margin: 0, letterSpacing: '-0.02em' }}>Admins</h2>
                            <p style={{ fontSize: 14, color: '#6b7280', margin: 0 }}>Manage and organize your admins.</p>
                        </div>
                    </div>
                    <button style={{ 
