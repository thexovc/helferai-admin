...
import { Plus, Search, Filter, Users, MoreVertical } from 'lucide-react';

export default function RolesPageClient() {
    return (
        <div>
            <Topbar title="Roles" subtitle="Define RBAC roles and granular permissions." product="inventory" />
            ...
            <div style={{ padding: 'var(--content-padding)' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16, marginBottom: 24 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        ...
                        <div>
                            <h2 style={{ fontSize: 24, fontWeight: 800, color: '#1a1a2e', margin: 0, letterSpacing: '-0.02em' }}>Roles</h2>
                            <p style={{ fontSize: 14, color: '#6b7280', margin: 0 }}>Manage and organize your roles.</p>
                        </div>
                    </div>
                    <button style={{ 
